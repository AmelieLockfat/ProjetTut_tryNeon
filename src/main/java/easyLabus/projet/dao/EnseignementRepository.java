...
public interface EnseignementRepository extends JpaRepository<Enseignement, String> {
    ...
    @Query(nativeQuery = true, value =
           "SELECT pers.prenompers as prenompers, pers.nompers as nompers, pers.numtel as nNumtel, pers.identifiant as identifiant, pers.email as email, pers.coordprivee as coordprivee "
